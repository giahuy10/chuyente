...
class RateModelDates extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		if (!JFactory::getUser()->authorise('core.edit', 'com_rate'))
		{
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.buy_rate LIKE ' . $search . '  OR  a.offer_rate LIKE ' . $search . ' )');
			}
		}
	...
	public function getItems()
	{
		...
		foreach ($items as $item)
		{
					...
					$item->time = JText::_('COM_RATE_DATES_TIME_OPTION_' . strtoupper($item->time));
		}
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_RATE_SEARCH_FILTER_DATE_FORMAT"), "warning");
